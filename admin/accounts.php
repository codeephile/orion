...
<body style="background-image: url(img/bgg.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        <div class="row tm-content-row tm-mt-big">
            ...
            <div class="tm-col tm-col-small">
                <div class="bg-white tm-block">
                    ...
                    <img src="img/profile.jpg" alt="Profile Image" class="img-fluid">
                    <div class="custom-file mt-3 mb-3">
                        <input id="fileInput" type="file" style="display:none;" />
                        <input type="button" class="btn btn-primary" value="Upload New" onclick="document.getElementById('fileInput').click();"
                        />
                    </div>
                </div>
            </div>
