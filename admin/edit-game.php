...
if (strlen($_SESSION['aid'])==0) {
    ...
    if(isset($_POST['update'])) {
        ...
        $query=mysqli_query($con, "update game1 set name='$product_name',description='$product_desc',price='$product_price' where id='$eid' ");
                ...
                <div class="bg-white tm-block">
                    ...
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            ...
                            <?php
                                $cid=$_GET['editid'];
                                $ret=mysqli_query($con,"select * from game1 where id='$cid'");
                                $cnt=1;
